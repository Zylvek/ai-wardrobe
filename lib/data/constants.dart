...
/// Версия алгоритма вырезания фона («фильтра»). Если улучшим алгоритм —
/// увеличиваем число, и вещи с прежней версией становятся «устаревшими»:
/// их можно перекроить из оригиналов кнопкой «Обновить фильтр».
/// v2: заливка дыр внутри вещи, сглаживание маски, мягкая кромка.
const String kFilterVersion = '2';
